...
'        Label2(4).Caption = "ＡＴＣ温度設定 DO1"
        ...
        otemp0 = T_keisu_cset(otemp0, T_keisu(T_keisuCont(1) - 1))  'otemp0
        Do
          DoEvents
             fintime = Timer2func     ' 2009.8.17
'          fintime = Timer         '現在時間
...
'
        ...
        End If
'
        fintime = Timer2func         '2002.10.09 KYOCERA   fintime:現在時間
'
'/* タイムアップ処理 */
      '2002.10.09 KYOCERA
...
'            Label2(4).Caption = "CASE N DO2"
          ...
          Case "W"    '/* 水冷却 */
            ...
            Select Case isub
            Case 1
'              Label2(4).Caption = "水冷却　ON2 DO2"
              SuireiON
            Case 0
'              Label2(4).Caption = "水冷却　OFF DO2"
              SuireiOFF
            End Select
          Case "R"    '/* ガス冷却 */
