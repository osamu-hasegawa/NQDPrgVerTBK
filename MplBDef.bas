...
Public Sub Ccw_Index(Mel As Object)
  If BrdFlg <> "ON" Then Exit Sub
   ...
   Ready_Wait
   Ack = MPL_BWaitDriveCommand(hDev, 0, MplResult)
   Call MplDataSet(-gRev2Disp * 2, MplData)                  'ÇhÇmÇbÇqÇdÇlÇdÇmÇsÇ`Çk ÇhÇmÇcÇdÇw ÇcÇqÇhÇuÇd ÇbÇnÇlÇlÇ`ÇmÇc
...
Public Sub C870Stop()
Dim Cmd%
'    Ready_Wait  !!! stopÉRÉ}ÉìÉhÇÕÅ@BUSYíÜÇ…èëÇ´çûÇﬁÇΩÇﬂÅAReadyWaitÇì¸ÇÍÇƒÇÕÇ¢ÇØÇ»Ç¢ÅBÅIÅI
...
'  Ready_WaitÅ@Å@!!! Ç±ÇÃÉRÉ}ÉìÉhÇÕÅ@BUSYíÜÇ…ì«Ç›èoÇ∑ÇΩÇﬂÅAReadyWaitÇì¸ÇÍÇƒÇÕÇ¢ÇØÇ»Ç¢ÅBÅIÅI
  Select Case no
  Case 1
