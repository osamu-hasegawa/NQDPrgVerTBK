...
'       Ver.NQD_70_080602 2008. 6. 2 s.f   Melec C-870 counter動作バグ修正　コンペアカウンタ値セット時　符号反転　　setcm1 azd=-ad * gVelDirct へ
'       Ver.NQD_70_080726 2008. 7.26 s.f
'       Ver.NQD_70_080731 2008. 7.31 s.f  型名称　保存へ
'       Ver.NQD_70_080912 2008. 9.12 s.f  アラームバグ取り・追加　roboデータに　圧力読み取り値の　ゼロ校正値追加
'       Ver.NQD_70_080912A 2008. 9.29 s.f  「メモ帳」使用できる様に、Vエディット「キャンセル」修正
'       Ver.NQD_71_081208 2008.12.08 s.f  ？周目の表示,　上型、下型　温度表示追加
'       Ver.NQD_71_090205 2009.02.05 s.f  アラーム表示　修正
'       Ver.NQD_71_090713 2009.07.13 s.f  アラーム表示　menuのパレット搬送中のdo　loop　へIf ArmChk <> 0 Thenの　アラーム表示追加
